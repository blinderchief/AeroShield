...
import type {
  IAssetManagerEvents,
  IAssetManagerEventsInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston2/IAssetManagerEvents";
...
export class IAssetManagerEvents__factory {
  static readonly abi = _abi;
  static createInterface(): IAssetManagerEventsInterface {
    return new Interface(_abi) as IAssetManagerEventsInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IAssetManagerEvents;
  }
}
