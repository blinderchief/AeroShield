...
import type {
  ICoreVaultClient,
  ICoreVaultClientInterface,
} from "../../../../@flarenetwork/flare-periphery-contracts/coston2/ICoreVaultClient";
...
export class ICoreVaultClient__factory {
  static readonly abi = _abi;
  static createInterface(): ICoreVaultClientInterface {
    return new Interface(_abi) as ICoreVaultClientInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ICoreVaultClient {
    return new Contract(address, _abi, runner) as unknown as ICoreVaultClient;
  }
}
