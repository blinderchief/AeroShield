...
export interface MockFLRInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockFLR extends BaseContract {
  connect(runner?: ContractRunner | null): MockFLR;
  waitForDeployment(): Promise<this>;

  interface: MockFLRInterface;
