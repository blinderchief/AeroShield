...
export interface ICoreVaultClientInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ICoreVaultClient extends BaseContract {
  connect(runner?: ContractRunner | null): ICoreVaultClient;
  waitForDeployment(): Promise<this>;

  interface: ICoreVaultClientInterface;
